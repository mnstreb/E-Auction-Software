...
window.AppHeader = (function() {
    ...
    let saveProjectBtnElem; // NEW: Reference for save project button
    ...
    let generateQuoteBtnElem;
    let quoteDropdownMenuElem;
    let exportPdfQuoteBtnElem;
    let emailClientBtnElem;

    let onThemeToggleCallback;
    let onReconfigureCallback;
    let onSaveProjectCallback; // NEW: Callback for save project button
     ...
     * @param {string} config.saveProjectBtnId - NEW: ID for the save project button.
     ...
     * @param {function} config.onSaveProject - NEW: Callback function for save project button.
    ...
    function init(config) {
        ...
        saveProjectBtnElem = document.getElementById(config.saveProjectBtnId); // NEW: Get save button reference
        ...
        // Quote Dropdown element references
        ...
        onSaveProjectCallback = config.onSaveProject; // NEW: Assign save callback
        // Assign callbacks for Report dropdown items
        onExportPdfReportCallback = config.onExportPdfReport;
        onExportCsvCallback = config.onExportCsv;
        // Assign callbacks for Quote dropdown items
        ...
        // NEW: Add event listener for save project button
        ...
        // Quote Dropdown button listener
        ...
        // Quote Dropdown menu item listeners
